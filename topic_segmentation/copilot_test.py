...
__init_path__ = 'C:\\Users\\ialve\\Desktop\\NewSegmentation\\topic_segmentation\\database\\'
...
# - # - # - # - # - # - # - # - # - # - # - # - # - # - # - #
def read_trial(number_of_trials) -> None:
    """
    ...
    if not os.path.exists(f'{__init_path__}\\ground_truth'):
        os.mkdir(f'{__init_path__}\\ground_truth')
    __init_path_len__ = os.listdir(f'{__init_path__}\\data').__len__()
    sucessful_index = __init_path_len__
    for _ in range(number_of_trials):
        noa = np.random.randint(4, 9)
        wiki_reader = WikipediaReader(noa)
        if wiki_reader.success:
            wiki_reader.save(path=__init_path__, index=sucessful_index)
            sucessful_index += 1
# - # - # - # - # - # - # - # - # - # - # - # - # - # - # - #
